...
var inputs = [
  {
    "type": "text",
    "placeholder": "FOLLOW_ROUTE GET_SHORTEST_PATH GESTION_SEMAFOROS...",
    "name": "_id",
    "description": "Identificador"
  },
  {
    "type": "text",
    "placeholder": "Identificador del servicio sin espacios",
    "name": "python_version",
    "description": "Version de Python"
  },
  {
    "type": "number",
    "placeholder": "Porcentaje de CPU estimado que se va a consumir",
    "name": "CPU",
    "description": "CPU"
  },
  {
    "type": "number",
    "placeholder": "Porcentaje de memoria RAM se va a consumir",
    "name": "RAM",
    "description": "RAM"
  },
  {
    "type": "text",
    "placeholder": "Identificadores de las dependencias seaparados por espacios",
    "name": "dependencies",
    "description": "Dependencias"
  },
  {
    "type": "text",
    "placeholder": "Añadir los params de entrada con sus tipos, separados por espacios(Ej: inicio<text> distancia<number>)",
    "name": "params",
...
function display_inputs() {
  var body = "<form action='http://localhost:3001/upload' method='POST' enctype='multipart/form-data'>"
	$.each(inputs, function(index, value){
    body += "<div class='form-group'>"
    body += "<label for='" + value["name"] + "'> " + value["description"]
	});
	body += "<input type='file' name='file'>""
	body += "<input type='submit' value='Subir'>"
	body += "</form>"
	input_container.append(body)
}
